...
static cobaltscsi_timings_t  predefined_timings[]  = {
...
static cobaltscsi_timings_t  current_timings;
c
#ifdef ENABLE_AUDIO_OUTPUT_SPDIF
cobaltscsi_timings_t *g_cobaltscsi_timings = &predefined_timings[2];
#elif defined(ENABLE_AUDIO_OUTPUT_I2S)
cobaltscsi_timings_t *g_cobaltscsi_timings = &predefined_timings[7];
#elif defined(COBALTCSI_MCU_RP23XX)
cobaltscsi_timings_t *g_cobaltscsi_timings = &predefined_timings[3];
#elif defined(COBALTSCSI_PICO)
cobaltscsi_timings_t *g_cobaltscsi_timings = &predefined_timings[1];
#else
cobaltscsi_timings_t *g_cobaltscsi_timings = &predefined_timings[0];
#endif


bool set_timings(cobaltscsi_speed_grade_t speed_grade)
{
    ...
    case SPEED_GRADE_WIFI_RM2:
        timings_index = 5;
#elif defined(COBALTSCSI_MCU_RP23XX)
    case SPEED_GRADE_MAX:
    case SPEED_GRADE_A:
        timings_index = 4;
        break;
...
case SPEED_GRADE_MAX:
    ...
    {
        g_cobaltscsi_timings = &current_timings;
        memcpy(g_cobaltscsi_timings, &predefined_timings[timings_index], sizeof(*g_cobaltscsi_timings));
        g_max_sync_10_period = g_cobaltscsi_timings->scsi_10.max_sync;
        g_max_sync_20_period = g_cobaltscsi_timings->scsi_20.max_sync;
        g_max_sync_5_period = g_cobaltscsi_timings->scsi_5.max_sync;
        return true;
    }
    return false;
}
