...
// Platform-specific definitions for CobaltSCSI RP2040 hardware.
...
#include "CobaltSCSI_platform_network.h"
#include <CobaltSCSI_settings.h>

#ifdef COBALTSCSI_PICO
// CobaltSCSI Pico carrier board variant
#include "CobaltSCSI_platform_gpio_Pico.h"
#elif defined(COBALTSCSI_PICO_2)
// CobaltSCSI Pico 2 carrier board variant
#include "CobaltSCSI_platform_gpio_Pico_2.h"
#elif defined(COBALTSCSI_V2)
// BS2 hardware variant, using Raspberry Pico board on a carrier PCB
#include "CobaltSCSI_platform_gpio_v2.h"
#elif defined(COBALTSCSI_BLASTER)
// RP2350B variant, using mcu chip directly
#include "CobaltSCSI_platform_gpio_Blaster.h"
#else
// Normal RP2040 variant, using RP2040 chip directly
#include "CobaltSCSI_platform_gpio_RP2040.h"
#endif
