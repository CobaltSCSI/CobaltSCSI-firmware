...
**/
#ifndef COBALTSCSI_TIMINGS_RP2MCU_H
#define COBALTSCSI_TIMINGS_RP2MCU_H
...
typedef struct
{
    ...
    struct
    {
        ...
        // Currently this has been decided to be within 0.02% from what the CobaltSCSI plays back compared to 44.1KHz
...
} cobaltscsi_timings_t;

extern  cobaltscsi_timings_t *g_cobaltscsi_timings;
...
#endif // COBALTSCSI_TIMINGS_RP2MCU_H
