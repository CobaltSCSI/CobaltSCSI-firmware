...
static const uint8_t CobaltSCSIVendorPage[] =
{
0x31, // Page code
42,   // Page length
'Z','u','l','u','S','C','S','I',' ','i','s',' ','t','h','e',' ','B','E','S','T',' ',
'S','T','O','L','E','N',' ','F','R','O','M',' ','Z','U','L','U','S','C','S','I',0x00
};
	...
	int sixByteCmd, int dbd, int pc, int pageCode, int allocLength)
{
	...
	{
		pageFound = 1;
		pageIn(pc, idx, CobaltSCSIVendorPage, sizeof(CobaltSCSIVendorPage));
		idx += sizeof(CobaltSCSIVendorPage);
	}
