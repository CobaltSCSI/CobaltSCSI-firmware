/**
 * This file is originally part of ZuluSCSI adopted for HackSCSI
 *
...
#pragma once
#include <CobaltSCSI_platform_config.h>

// Use variables for version number
#define FW_VER_NUM      "2025.06.20"
// rel or dev only.
#define FW_VER_SUFFIX   "SearchAndReplace"

#define DEF_STRINGFY(DEF) STRINGFY(DEF)
#define STRINGFY(STR) #STR
#define FIRMWARE_NAME_PREFIX DEF_STRINGFY(BUILD_ENV)
#define COBALT_FW_VERSION FW_VER_NUM "-" FW_VER_SUFFIX
#define INQUIRY_NAME  PLATFORM_NAME "v" FW_VER_NUM
#define TOOLBOX_API 0

// Configuration and log file paths
#define CONFIGFILE  "cobaltscsi.ini"
#define LOGFILE     "log.txt"
#define CRASHFILE   "err.txt"
#define FIRMWARE_PREFIX "CobaltSCSI-FW"
...
#define DRIVEINFO_FIXED     {"HackSCSI", "HARDDRIVE", PLATFORM_REVISION, ""}
#define DRIVEINFO_REMOVABLE {"HackSCSI", "REMOVABLE", PLATFORM_REVISION, ""}
#define DRIVEINFO_OPTICAL   {"HackSCSI", "CDROM",     PLATFORM_REVISION, ""}
#define DRIVEINFO_FLOPPY    {"HackSCSI", "FLOPPY",    PLATFORM_REVISION, ""}
#define DRIVEINFO_MAGOPT    {"HackSCSI", "MO_DRIVE",  PLATFORM_REVISION, ""}
#define DRIVEINFO_NETWORK   {"Dayna",    "SCSI/Link",       "2.0f", ""}
#define DRIVEINFO_TAPE      {"HackSCSI", "TAPE",      PLATFORM_REVISION, ""}
...
#define APPLE_DRIVEINFO_FIXED     {"QUANTUM",  "HackSCSI Pico",      PLATFORM_REVISION, "1.0"}
...
#define APPLE_DRIVEINFO_TAPE      {"HackSCSI", "APPLE_TAPE",        PLATFORM_REVISION, ""}
